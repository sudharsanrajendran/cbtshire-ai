  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#f8fafc', py: { xs: 4, md: 8 }, px: { xs: 2, md: 4 } }}>
      <Box sx={{ maxWidth: 780, mx: 'auto' }}>
        ...
        {/* Application Form or Success Box */}
        <Card elevation={2} sx={{ borderRadius: 3, border: '1px solid #e2e8f0' }}>
          <CardContent sx={{ p: { xs: 3, sm: 4 } }}>
            {submitted ? (
              <Box sx={{ textAlign: 'center', py: 4 }}>
                <CheckCircleRoundedIcon sx={{ fontSize: 64, color: '#10b981', mb: 2 }} />
                <Typography variant="h4" fontWeight={900} sx={{ color: '#0f172a', mb: 1 }}>
                  Application Submitted!
                </Typography>
                <Typography variant="body1" sx={{ color: '#475569', maxWidth: 520, mx: 'auto', lineHeight: 1.7 }}>
                  Thank you, <strong>{form.name}</strong>. We have received your application and resume for <strong>{job.title}</strong>.
                </Typography>

                <Paper elevation={0} sx={{ p: 2.5, bgcolor: '#f0fdf4', border: '1px solid #86efac', borderRadius: 2.5, mt: 3, textAlign: 'left', maxWidth: 540, mx: 'auto' }}>
                  <Typography variant="subtitle2" fontWeight={800} sx={{ color: '#166534', mb: 0.5 }}>
                    📌 What happens next?
                  </Typography>
                  <Typography variant="body2" sx={{ color: '#15803d', lineHeight: 1.6 }}>
                    Our recruiting team and AI screening system are reviewing your resume. If your profile is shortlisted, our HR team will send the official assessment link and next steps directly to <strong>{form.email}</strong>.
                  </Typography>
                </Paper>
